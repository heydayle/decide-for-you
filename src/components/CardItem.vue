  ...
  <div class="card-container">
    <div class="card">
      ...
      <div class="card-bg">
        ...
        <div class="mystic-symbol" style="bottom: 40px; left: 50%; transform: translateX(-50%);">♥</div>
        <div class="mystic-symbol" style="top: 50%; left: 40px; transform: translateY(-50%);">♣</div>
        <div class="mystic-symbol" style="top: 50%; right: 40px; transform: translateY(-50%);">♦</div>
